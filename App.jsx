...
export default function App(){
  ...
  useEffect(()=>{
    ...
    s.innerHTML=`!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','2126436034765739');fbq('track','PageView');`;
  ...
  if(!user)return(
    <div className="login"><div className="login-card">
      ...
      <button className="google-btn" onClick={()=>signInWithPopup(auth,googleProvider).then(()=>{if(window.fbq)window.fbq('track','CompleteRegistration');})}>
